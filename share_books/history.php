...
?>  
    <h1>交換紀錄
        <select name="changeProject" id="selectPj">
            ...
            <option value="success">交換成功</option>
            <option value="fail">交換失敗</option>
        </select>
    </h1>
...
<script>
    ...
    function view(e) {
        ...
        projectStr += ` <section class="project his_p" data-project ="${item.orderID}">
            <div class="mybook">
                        ...
                        <div class="card_main">
                            ...
                            <div class="text_content">
                                ...
                                <form method="post" action="book_stor_aj.php">
                                    <input type="hidden" name="hisMsg" value="ok">
